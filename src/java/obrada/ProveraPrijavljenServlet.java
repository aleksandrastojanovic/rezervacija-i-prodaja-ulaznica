/*
- proverava da li je korisnik prijavljen, ako nije, ide na prijava.jsp,
- ako jeste, ide na odjavu
 */
package obrada;
...
public class ProveraPrijavljenServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProveraPrijavljenServlet.class.getName()).log(Level.SEVERE, null, ex);
